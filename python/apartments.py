...
driver_file = Service(
    "/Users/jamarionhines/Downloads/chromedriver-mac-arm64/chromedriver"
)

window = webdriver.Chrome(service=driver_file, options=chrome_options)
...
if url.find("?") == -1:
    ...
    for web in range(1, pages + 1):
        ...
        noQ_driver = webdriver.Chrome(service=driver_file, options=chrome_options)
    ...
    for web in range(1, pages + 1):
        ...
        Q_driver = webdriver.Chrome(service=driver_file, options=chrome_options)
        Q_driver.get(url)
